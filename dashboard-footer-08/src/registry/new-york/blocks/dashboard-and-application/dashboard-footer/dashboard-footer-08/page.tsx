import { FacebookIcon, GithubIcon, InstagramIcon, TwitterIcon, UploadIcon } from 'lucide-react'
...
const Footer = () => {
  return (
    <div className='flex min-h-dvh w-full flex-col'>
      <SidebarProvider>
        <Sidebar collapsible='icon' className='h-[calc(100svh-6.625rem)]'>
      ...
      <footer className='bg-card sticky bottom-0 z-50 border-t'>
        <div className='flex items-center justify-between gap-3 px-4 py-3 max-md:flex-col sm:px-6 md:gap-6 md:py-2.5'>
          ...
          <div className='flex items-center gap-3 text-sm whitespace-nowrap max-[500px]:flex-col min-[500px]:gap-5'>
        ...
        <div className='flex items-center justify-center gap-3 border-t px-4 py-4 max-md:flex-col sm:px-6 md:gap-6'>
