    ...
    <div className='flex min-h-dvh w-full'>
      <SidebarProvider>
        ...
        <div className='flex flex-1 flex-col'>
          ...
          <footer className='flex items-center justify-between gap-3 bg-indigo-600 px-4 py-3 text-white max-lg:flex-col sm:px-6 lg:gap-6 lg:py-2'>
            <a href='#'>
              <Logo className='[&_line]:stroke-indigo-600 dark:[&_line]:stroke-indigo-600 [&_path]:stroke-indigo-600 dark:[&_path]:stroke-indigo-600 [&_rect]:fill-white' />
            </a>
            <p className='text-center text-sm text-balance'>
              {`©${new Date().getFullYear()}`} <a href='#'>Shadcn/studio</a>, Made for better web design
            </p>
