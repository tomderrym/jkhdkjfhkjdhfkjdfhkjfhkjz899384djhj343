/**
 * Shadcn Block: dashboard-dialog-13
 * A project sharing dialog with avatar display, user selection, input fields, select dropdowns, and scroll area for collaborative project management.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/dashboard-dialog-13/dialog-share-project.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: avatar, button, dialog, input, label, scroll-area, select, separator, utils
 */
