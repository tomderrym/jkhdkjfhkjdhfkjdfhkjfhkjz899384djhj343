/**
 * Shadcn Block: chart-component-14
 * DevOps metrics dashboard with deployment frequency, error rates, and system reliability indicators.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/chart-earning-insights.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: avatar, badge, button, card, chart, dropdown-menu, progress, utils
 */
