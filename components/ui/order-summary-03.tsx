/**
 * Shadcn Block: order-summary-03
 * Full-page card layout order summary with order number header, item grid showing color/size details, delivery dates, track/cancel action buttons, and total pricing
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/order-summary-03/order-summary-03.tsx
 * Dependencies: none
