/**
 * Shadcn Block: dashboard-dialog-05
 * A seat selection dialog with capacity management, slider controls, switch toggles, and badge indicators for event or workspace planning.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/dashboard-dialog-05/dialog-choose-seats.tsx
 * Dependencies: none
 * Registry Dependencies: badge, button, dialog, label, slider, switch, utils
 */
