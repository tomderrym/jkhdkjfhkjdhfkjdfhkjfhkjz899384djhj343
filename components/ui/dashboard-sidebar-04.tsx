/**
 * Shadcn Block: dashboard-sidebar-04
 * Trading Hub dashboard sidebar with financial trading navigation including Portfolio, Market, Trading sections, analytics tools like Stocks, Scanner, and Analytics, plus custom icon-based collapsed state design
 * 
 * Auto-extracted from: src/registry/new-york/blocks/dashboard-and-application/dashboard-sidebar/dashboard-sidebar-04/page.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: card, collapsible, scroll-area, sidebar
 */
