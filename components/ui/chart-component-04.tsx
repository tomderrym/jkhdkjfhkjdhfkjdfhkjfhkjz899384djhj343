/**
 * Shadcn Block: chart-component-04
 * Conversion rate dashboard with percentage display, trend indicators, area chart visualization, and campaign performance list with individual trend arrows.
 * 
