/**
 * Shadcn Block: dashboard-sidebar-05
 * Restaurant POS dashboard sidebar with pizza icon branding, order management including New Order, Inventory, Discount tracking, Ordering Table management, Customer Management, and Staff Management, plus today's order statistics with team avatars
 * 
 * Auto-extracted from: src/registry/new-york/blocks/dashboard-and-application/dashboard-sidebar/dashboard-sidebar-05/page.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: avatar, card, collapsible, sidebar
 */
