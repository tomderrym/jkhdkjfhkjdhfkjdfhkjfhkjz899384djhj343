/**
 * Shadcn Block: forgot-password-03
 * Two-column split layout with password reset form on left and testimonial card featuring user avatars, quote, and decorative background on right for trust building
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/forgot-password-03/forgot-password-03.tsx
 * Dependencies: none
 * Registry Dependencies: avatar, button, card, input, label, utils
 */
