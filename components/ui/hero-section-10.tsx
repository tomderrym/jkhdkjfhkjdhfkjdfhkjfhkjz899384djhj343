/**
 * Shadcn Block: hero-section-10
 * Split-screen layout with left content area containing avatar testimonials and star ratings, plus right dashboard preview section for SaaS platform showcase
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/hero-section-10/header.tsx
 * Dependencies: lucide-react, motion
 * Registry Dependencies: avatar, button, collapsible, dropdown-menu, navigation-menu, separator, tooltip, utils
 */
