/**
 * Shadcn Block: order-summary-05
 * Tabbed order interface with summary/payment/delivery tabs, timeline component for order tracking, product list with descriptions, customer info sections, and invoice buttons
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/order-summary-05/order-summary-05.tsx
 * Dependencies: none
 * Registry Dependencies: button, card, separator, tabs, utils
 */
