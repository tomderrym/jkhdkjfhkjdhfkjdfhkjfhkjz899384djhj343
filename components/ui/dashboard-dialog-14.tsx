/**
 * Shadcn Block: dashboard-dialog-14
 * An address addition dialog with form inputs, radio group selections, switch toggles, select dropdowns, and scroll area for address management.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/dashboard-dialog-14/dialog-add-address.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: button, dialog, input, label, radio-group, scroll-area, select, switch, utils
 */
