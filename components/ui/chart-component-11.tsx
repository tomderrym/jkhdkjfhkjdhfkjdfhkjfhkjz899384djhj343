/**
 * Shadcn Block: chart-component-11
 * Finance dashboard with yearly report overview featuring bar chart for profit, income, and expense data, plus financial summary cards with total amounts.
 * 
