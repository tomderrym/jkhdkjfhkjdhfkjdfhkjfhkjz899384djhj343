/**
 * Shadcn Block: forgot-password-02
 * Two-column grid layout with dashboard preview featuring border beam animation and password reset form with back navigation for enhanced user experience
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/forgot-password-02/forgot-password-02.tsx
 * Dependencies: lucide-react, motion
 * Registry Dependencies: button, input, label, utils
 */
...
const AuthFullBackgroundShape = () => null;
