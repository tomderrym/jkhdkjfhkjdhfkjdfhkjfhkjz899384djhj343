/**
 * Shadcn Block: dashboard-sidebar-03
 * Travel agency dashboard sidebar with comprehensive booking services including Hotel, Flight, Bus, Car, and Ship Booking, location search functionality, and "Book now" action button in footer
 * 
 * Auto-extracted from: src/registry/new-york/blocks/dashboard-and-application/dashboard-sidebar/dashboard-sidebar-03/page.tsx
