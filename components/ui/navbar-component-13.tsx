/**
 * Shadcn Block: navbar-component-13
 * A sophisticated two-level navigation system with mobile-responsive sheet menu, comprehensive navigation menu with dropdowns, integrated search, notifications, and profile management. Features a secondary navigation row with store dropdown, ideal for complex applications requiring extensive navigation options.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/navbar-component-13/navbar-component-13.tsx
 * Dependencies: lucide-react, react-use
 * Registry Dependencies: avatar, badge, button, collapsible, dropdown-menu, input, navigation-menu, tabs, sheet, utils
 */
...
import MenuSheet from '@/components/builder-components'
