/**
 * Shadcn Block: dashboard-dropdown-20
 * A tag management dropdown with badges, checkboxes, command interface, and popover functionality for content tagging and organization.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/dashboard-dropdown-20/tag-dropdown.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: badge, button, input, checkbox, command, label, popover, utils
 */
