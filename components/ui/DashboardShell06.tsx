...
// Placeholder - original component not available
const StatisticsTotalRevenueCard = () => <div>Component placeholder</div>;
// Placeholder - original component not available
// // // import StatisticsImpressionCard from '@/components/shadcn-studio/blocks/statistics-impression-card'
// Placeholder - original component not available
const StatisticsImpressionCard = () => <div>Component placeholder</div>;
// Placeholder - original component not available
...
// Placeholder - original component not available
const CourseDatatable = () => <div>Component placeholder</div>;
// Placeholder - original component not available
type MenuSubItem = {
  label: string
  href: string
