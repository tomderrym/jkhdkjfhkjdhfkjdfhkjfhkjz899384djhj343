/**
 * Shadcn Block: dashboard-dropdown-11
 * A status selection dropdown with avatar display, status indicators, and availability options for user presence and activity management.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/dashboard-dropdown-11/status-dropdown.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: avatar, dropdown-menu, utils
 */
