/**
 * Shadcn Block: contact-us-page-05
 * Three-column location cards layout with custom SVG illustrations, contact details (email and phone), and map location buttons featuring motion animations
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/contact-us-page-05/contact-us-page-05.tsx
 * Dependencies: motion
