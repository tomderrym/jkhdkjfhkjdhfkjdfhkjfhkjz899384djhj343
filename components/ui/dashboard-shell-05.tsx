/**
 * Shadcn Block: dashboard-shell-05
 * Feature-rich productivity dashboard shell with project switcher, quick action buttons, contextual toolbars, dynamic widgets, and comprehensive workspace management for development and creative applications
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/chart-total-revenue.tsx
 * Dependencies: @tanstack/react-table, class-variance-authority, lucide-react
 * Registry Dependencies: avatar, badge, button, card, chart, checkbox, collapsible, command, dropdown-menu, input, label, pagination, progress, separator, select, sheet, sidebar, table, tabs, tooltip, utils
 */
