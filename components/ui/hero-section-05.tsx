/**
 * Shadcn Block: hero-section-05
 * Two-column grid layout with left content area and right background image, horizontal download button row, metrics display with avatar group testimonials, and muted background section
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/hero-section-05/header.tsx
  ...
  return (
    ...
    >
      <div className='mx-auto flex h-full max-w-7xl items-center justify-between gap-6 px-4 sm:px-6 lg:px-8'>
        ...
        {/* Login Button */}
        <Button variant='secondary' className='border max-md:hidden' asChild>
          <a href='#'>Login</a>
        </Button>
