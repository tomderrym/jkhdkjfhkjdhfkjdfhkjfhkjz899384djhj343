/**
 * Shadcn Block: dashboard-shell-04
 * Multi-level navigation dashboard shell with nested menu structures, team switching capabilities, data export functions, and advanced filtering for complex organizational hierarchies and enterprise management
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/chart-earning-insights.tsx
 * Dependencies: @tanstack/react-table, lucide-react, papaparse, react-use, xlsx
 * Registry Dependencies: avatar, breadcrumb, badge, button, card, chart, checkbox, collapsible, dropdown-menu, input, label, navigation-menu, pagination, progress, select, separator, sheet, switch, table, tabs, utils
 */
