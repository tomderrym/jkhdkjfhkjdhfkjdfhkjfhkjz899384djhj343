/**
 * Shadcn Block: navbar-component-08
 * A streamlined application header with logo on the left, prominent rounded search bar in the center, and utility icons (calendar, notifications, messages) plus user avatar on the right. Features notification indicators and clean spacing for productivity-focused applications.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/navbar-component-08/navbar-component-08.tsx
