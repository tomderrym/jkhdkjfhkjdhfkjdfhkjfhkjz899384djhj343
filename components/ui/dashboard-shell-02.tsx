/**
 * Shadcn Block: dashboard-shell-02
 * Advanced dashboard layout with collapsible sidebar navigation, search dialog, notification dropdown, user data tables, income charts, and comprehensive widget components for enterprise user management
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/chart-total-earning.tsx
