/**
 * Shadcn Block: order-summary-02
 * Wide dialog modal with sidebar customer information card, main product grid with quantity adjusters, order metadata, and scrollable layout for detailed summaries
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/order-summary-02/order-summary-02.tsx
