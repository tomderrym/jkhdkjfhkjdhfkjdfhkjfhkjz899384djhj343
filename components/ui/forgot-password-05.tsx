/**
 * Shadcn Block: forgot-password-05
 * Centered elevated card with gradient header, decorative line patterns, logo branding, and form inputs for elegant password reset experience
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/forgot-password-05/forgot-password-05.tsx
 * Dependencies: none
