/**
 * Shadcn Block: navbar-component-03
 * A sophisticated two-row navigation layout with utility icons (search, user, cart) in the top row and main navigation links in the bottom row. Features split navigation design with logo centered between sections, perfect for e-commerce and content-rich websites.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/navbar-component-03/navbar-component-03.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: button, dropdown-menu, separator
 */
