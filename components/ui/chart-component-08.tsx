/**
 * Shadcn Block: chart-component-08
 * Anatomy detection dashboard with user views bar chart, product reach percentage display, prediction analytics, and alert indicator for monitoring detection metrics.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/chart-anatomy-detected.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: avatar, button, card, chart, utils
 */
