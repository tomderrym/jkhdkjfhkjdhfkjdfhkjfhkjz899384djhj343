/**
 * Shadcn Block: hero-section-09
 * Centered layout with inline 3D flip text animation using CSS transforms, horizontal button row with CLI copy functionality, and absolute positioned right-aligned mobile screen image
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/hero-section-09/header.tsx
 * Dependencies: lucide-react, motion
 * Registry Dependencies: button, collapsible, dropdown-menu, navigation-menu, separator, tooltip, utils
 */
