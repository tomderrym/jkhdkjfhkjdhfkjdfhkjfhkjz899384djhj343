/**
 * Shadcn Block: chart-component-22
 * Comprehensive business metrics dashboard with revenue tracking, growth indicators, and performance summaries.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/chart-total-transaction.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: avatar, button, card, chart, dropdown-menu, separator, utils
 */
