/**
 * Shadcn Block: offer-modal-04
 * Interactive fortune wheel modal with email-to-spin mechanic, animated wheel with color segments, percentage discount results, and alert notification for prizes
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/offer-modal-04/offer-modal-04.tsx
 * Dependencies: none
 * Registry Dependencies: button, dialog, input, alert, utils
 */
