/**
 * Shadcn Block: chart-component-20
 * IoT sensor data visualization with device monitoring, anomaly detection, and predictive analytics.
 * 
 * Auto-extracted from: src/registry/new-york/components/blocks/chart-project-timeline.tsx
