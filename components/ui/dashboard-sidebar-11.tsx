/**
 * Shadcn Block: dashboard-sidebar-11
 * Logistics management dashboard sidebar with custom icons and delivery tracking features including Dashboard overview, Package Tracking with location mapping, Inventory management, Warehouse operations, and delivery process visualization with progress indicators
 * 
 * Auto-extracted from: src/registry/new-york/blocks/dashboard-and-application/dashboard-sidebar/dashboard-sidebar-11/page.tsx
 * Dependencies: lucide-react
 * Registry Dependencies: card, progress, sidebar
 */
    ...
    <div className='flex min-h-dvh w-full'>
      <SidebarProvider defaultOpen={false} style={{ '--sidebar-width-icon': '3.5625rem' } as CSSProperties}>
        ...
        <div className='flex flex-1 flex-col'>
          <header className='bg-card sticky top-0 z-50 flex h-13.75 items-center justify-between gap-6 border-b px-4 max-lg:py-2 sm:px-6'>
