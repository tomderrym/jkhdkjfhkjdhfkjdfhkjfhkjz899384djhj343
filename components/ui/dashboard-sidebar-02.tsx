/**
 * Shadcn Block: dashboard-sidebar-02
 * Enhanced social media analytics dashboard sidebar with user profile header featuring avatar and social media links, collapsible navigation with submenu items, Content Performance tracking, and logo footer
 * 
 * Auto-extracted from: src/registry/new-york/blocks/dashboard-and-application/dashboard-sidebar/dashboard-sidebar-02/page.tsx
