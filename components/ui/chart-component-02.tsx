/**
 * Shadcn Block: chart-component-02
 * Earnings report card with dropdown menu, progress indicator, statistical data list with trend arrows, and bar chart visualization for daily earning analysis.
 * 
