/**
 * Shadcn Block: chart-component-05
 * Total earning dashboard with percentage display, growth trend indicators, stacked bar chart comparing yearly data, and revenue breakdown with payment status.
 * 
