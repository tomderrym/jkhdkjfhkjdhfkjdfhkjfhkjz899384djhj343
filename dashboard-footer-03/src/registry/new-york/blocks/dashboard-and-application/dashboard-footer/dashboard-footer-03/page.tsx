import { ChevronUpIcon, SettingsIcon, SlidersVerticalIcon } from 'lucide-react'
    ...
    <div className='flex min-h-dvh w-full'>
      <SidebarProvider>
        ...
        <div className='flex flex-1 flex-col'>
          ...
          <footer className='flex items-center justify-between gap-3 px-4 py-3 max-sm:flex-col sm:gap-6 sm:px-6'>
            ...
            <div className='flex items-center gap-5'>
              <LanguageDropdown
                align='center'
                trigger={
                  <Button variant='ghost' size='sm' className='[&[data-state=open]>svg]:-rotate-180'>
                    Language
