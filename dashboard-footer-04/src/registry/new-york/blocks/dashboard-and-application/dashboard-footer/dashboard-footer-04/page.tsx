import { ChevronUpIcon, FacebookIcon, GithubIcon, TwitterIcon } from 'lucide-react'
    ...
    <div className='flex min-h-dvh w-full'>
      <SidebarProvider>
        ...
        <div className='flex flex-1 flex-col'>
          ...
          <footer>
            <div className='flex items-center justify-between gap-3 px-4 py-2 max-lg:flex-col lg:gap-6 lg:px-6'>
              ...
              <LanguageDropdown
                trigger={
                  <Button
                    variant='ghost'
                    size='sm'
                    className='hidden sm:inline-flex [&[data-state=open]>svg]:-rotate-180'
                  >
                    Language
                    <ChevronUpIcon className='transition-transform duration-200 ease-in-out' />
                  </Button>
                }
              />
              <LanguageDropdown
                align='center'
                trigger={
                  <Button variant='ghost' size='sm' className='sm:hidden [&[data-state=open]>svg]:-rotate-180'>
                    Language
                    <ChevronUpIcon className='transition-transform duration-200 ease-in-out' />
                  </Button>
                }
            ...
            <div className='text-muted-foreground flex items-center justify-between gap-3 border-t px-4 py-5 max-sm:flex-col sm:gap-6 sm:px-6'>
